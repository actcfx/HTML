			...
			<div class="row mt-1">
				<div class="col-md-8 offset-md-2">
					<div class="card">
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
                                    ...
                                    <td><?php echo $student['seatNo'];?></td>
                                        ...
                                        ?>
										<td><a href="hw01_updateform.php?seatNo=<?php echo $student['seatNo'];?>">編輯</a>/<a href="hw01_delete.php?seatNo=<?php echo $student['seatNo'];?>">刪除</a></td>
									</tr>
									<?php
									}
									?>
                        ...
                        <form method = "post">
                            <button formaction = "hw01_insertform.php" class = "btn btn-primary" type = "submit">新增</button>
                            <button formaction = "hw01_reset.php" class = "btn btn-primary" type = "submit">重置</button>
                        </form>
						</div>
					</div>
				</div>
