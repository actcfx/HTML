				...
				<div class="col-md-8 offset-md-2 col-xl-6 offset-xl-3">
					<div class="card">
						...
						<div class="card-body">
                            ...
                            email：<span class='text-primary'><?php echo $_POST['email']; ?></span><br>
                            身分證字號：<span class='text-primary'><?php echo $_POST['useric']; ?></span><br>
                            生日：<span class='text-primary'><?php echo $_POST['date1']; ?></span><br>
